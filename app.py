...
def main():
	...
	if choice == "Home":
		...
		profile_options_list = ['username', 'name', 'life' , 'address', 'mail' , 'birthdate''job', 'company', 'ssn', 'residence', 'current_location', 'blood_group', 'website'] 
		...
		st.info("Ahmed Hamdy @AhmedHamdyTech")
		st.text("By Ahmed Hamdy(AhmedHamdy)")
